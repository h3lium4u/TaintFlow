    ...
    pub fn register_defaults(&mut self) {
        ...
        self.register(LibraryStub {
            ...
            methods: vec![
                ...
                MethodStub {
                    name: "encodeBase64URLSafe".to_string(),
                    kind: StubKind::Propagator,
                    propagates_from: Some(vec![0]),
                },
                MethodStub {
                    name: "encodeBase64URLSafeString".to_string(),
                    kind: StubKind::Propagator,
                    propagates_from: Some(vec![0]),
                },
                MethodStub {
        ...
        // java.util.Map & java.util.HashMap (Collection Propagation)
        self.register(LibraryStub {
            class_fqn: "java.util.Map".to_string(),
            methods: vec![
                MethodStub {
                    name: "get".to_string(),
                    kind: StubKind::Propagator,
        ...
        self.register(LibraryStub {
            class_fqn: "java.util.HashMap".to_string(),
            methods: vec![
                MethodStub {
                    name: "get".to_string(),
                    kind: StubKind::Propagator,
        ...
        // javax.crypto.Cipher (CWE-327)
        self.register(LibraryStub {
            class_fqn: "javax.crypto.Cipher".to_string(),
            methods: vec![
                MethodStub {
                    name: "doFinal".to_string(),
                    kind: StubKind::Sink,
                    propagates_from: None,
                },
                MethodStub {
        ...
        // java.security.MessageDigest (CWE-328)
        self.register(LibraryStub {
            class_fqn: "java.security.MessageDigest".to_string(),
            methods: vec![
                MethodStub {
        ...
        // SaltStack filesystem/path sanitizers
        self.register(LibraryStub {
            class_fqn: "salt.utils.path".to_string(),
            methods: vec![
                MethodStub {
                    name: "safe_path".to_string(),
                    kind: StubKind::Sanitizer,
                    propagates_from: None,
                },
            ],
