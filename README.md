...
*Taint analysis · ML vulnerability detection · Python & Java · CWE classification*
...
TaintFlow RC2 is a production-grade security scanner that combines:
...
```bash
git clone https://github.com/yourname/taintflow
...
```
TaintFlow RC2 Scan Report - Found 2 issues:
...
| Model | MCC | ROC-AUC |
| :--- | :--- | :--- |
| **TaintFlow RC2 (LightGBM)** | **0.6020** | **0.8878** |
